...
class Model:
    ...
    def preprocessing_data(self):
        print 'timeseries1'
        timeseries = TimeseriesBNN(self.original_data, self.train_size, self.valid_size, self.sliding_encoder, self.sliding_decoder, self.time_step)
        print 'timeseries'
    ...
    def fit(self):
        ...
        out_weights=tf.Variable(tf.random_normal([self.sliding_decoder/self.time_step,self.n_output]))
