...
class Model:
    ...
    def fit(self):
        ...
        with tf.Session() as sess:
            ...
            folder_to_save_result = 'results/multivariate/mem/5minutes/bnn_multivariate_uber_ver3/'
            ...
            save_path = saver.save(sess, 'results/multivariate/mem/5minutes/bnn_multivariate_uber_ver3/model_saved/' +  file_name)
