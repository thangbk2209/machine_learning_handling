...
class Model:
    ...
    def fit(self):
        ...
        with tf.Session() as sess:
            ...
            folder_to_save_result = 'results/fuzzy/multivariate/cpu/5minutes/bnn_multivariate_uber/'
            ...
            save_path = saver.save(sess, 'results/fuzzy/multivariate/cpu/5minutes/bnn_multivariate_uber/model_saved/' +  file_name)
