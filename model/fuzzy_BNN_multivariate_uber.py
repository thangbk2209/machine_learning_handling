...
class Model:
    ...
    def fit(self):
        ...
        with tf.Session() as sess:
            ...
            folder_to_save_result = 'results/fuzzy/multivariate/mem/5minutes/bnn_multivariate_uber_ver4/'
            ...
            save_path = saver.save(sess, 'results/fuzzy/multivariate/mem/5minutes/bnn_multivariate_uber_ver4/model_saved/' +  file_name)
