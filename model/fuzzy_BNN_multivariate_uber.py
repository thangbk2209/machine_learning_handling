...
class Model:
    ...
    def fit(self):
        ...
        with tf.Session() as sess:
            ...
            folder_to_save_result = 'results/univariate/cpu/5minutes/bnn_uber/'
            ...
            save_path = saver.save(sess, 'results/univariate/cpu/5minutes/bnn_uber/model_saved/' +  file_name)
